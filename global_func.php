...
function get_gameranks($level, $housevalue, $stats)
{
    ...
    if ($tp < 100000) {
        ...
        return " Rookie";
    } else if ($tp < 102400000) {
        return " Average";
    } else if ($tp < 409600000) {
        return " Good";
    } else if ($tp < 819200000) {
        return " Very Good";
    } else if ($tp < 3276800000) {
        return " Greater Than Average";
    } else if ($tp < 13107200000) {
        return " Experienced";
    } else if ($tp < 52428800000) {
        return " Highly Experienced";
    } else if ($tp < 209715200000) {
        return " Honoured";
    } else if ($tp < 838860800000) {
        return " Highly Hounoured";
    } else if ($tp < 3355443200000) {
        return " Respect King";
    } else if ($tp < 6655886400000) {
