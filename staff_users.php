...
<div class='generalinfo_simple'><br> <br><br>
      ...
      <form action='staff_users.php?action=deluser&step=2' method='post'>
      User: <input type='text' STYLE='color: black;  background-color: white;' name='user' value='0' /><br />
      <input type='submit' STYLE='color: black;  background-color: white;' value='Delete User' /></form></div><div><img src='images/generalinfo_btm.jpg' alt='' /></div><br></div></div></div></div></div>";
            break;
        case 2:
            $target = $_POST['user'];
...
<div class='generalinfo_simple'><br> <br><br>
      ...
      <input type='submit' STYLE='color: black;  background-color: white;' name='yesorno' value='No' onclick=\"window.location='staff_users.php?action=deluser';\" /></form></div><div><img src='images/generalinfo_btm.jpg' alt='' /></div><br></div></div></div></div></div>";
            break;
        case 3:
            $target = $_POST['userid'];
            if (!is_numeric($target)) exit;
