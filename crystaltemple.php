...
<h4 class='style1b'>Welcome to the Recoplas temple!</h4>
<br />
You have <b>{$ir['crystals']}</b> Recoplas.<br />
What would you like to spend your Recoplas on?<br />
<br />


<table class=table>

<tr><td><a href='crystaltemple.php?spend=refill'>Energy Refill </td><td> {$set['ct_refillprice']} Recoplas</a></td></tr>
<tr><td><a href='crystaltemple.php?spend=IQ'>IQ </td><td> {$set['ct_iqpercrys']} IQ per Recoplas</a></td></tr>
<tr><td><a href='crystaltemple.php?spend=rob'>Rob Skill </td><td> 1 Rob Skill per 200 Recoplas</a></td></tr>     
<tr><td><a href='crystaltemple.php?spend=money'>Money </td><td> \$" . number_format($set['ct_moneypercrys']) . " per Recoplas</a></td></tr>
</table> </div>
<div><img src='images/generalinfo_btm.jpg' alt='' /></div><br> </div></div></div> </div> </div> ";
    ...
    if ($_GET['spend'] == 'refill') {
        if ($ir['crystals'] < $set['ct_refillprice']) {
            print "You don't have enough Recoplas!";
            ...
            print "You have paid {$set['ct_refillprice']} Recoplas to refill your energy bar.";
        }
    }
    ...
    if ($_GET['spend'] == 'rob') {
        if ($ir['crystals'] < 200) {
            ...
            print "You have paid 200 Recoplas for One Rob Skill";
        }
...
<div><img src='images/generalinfo_btm.jpg' alt='' /></div><br> </div></div></div> </div> </div>";
        ...
        if ($_POST['crystals'] <= 0 || $_POST['crystals'] > $ir['crystals']) {
            print "Error, you either do not have enough Recoplas or did not fill out the form.<br />
<a href='crystaltemple.php?spend=IQ'>Back</a>";
            ...
            print "You traded {$_POST['crystals']} Recoplas for $iqgain IQ.";
        }
    } else if ($_GET['spend'] == 'money') {
        print "<div class='icolumn2' id='mainContentDiv'>
<div><img src='images/generalinfo_top.jpg' alt='' /></div>
<div class='generalinfo_simple'>Type in the amount of Recoplas you want to swap for money.<br />
You have <b>{$ir['crystals']}</b> Recoplas.<br />
...
<a href='crystaltemple.php?spend=money'>Back</a>";
            ...
            print "You traded {$_POST['crystals']} Recoplas for \$" . number_format($iqgain) . ".";
        }
    }
}
